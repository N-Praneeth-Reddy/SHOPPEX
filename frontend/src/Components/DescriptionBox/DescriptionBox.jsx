  ...
  return (
    <div className="descriptionbox">
      ...
      <div className="descriptionbox-description">
        ...
        <p>An eCommerce website is an online destination where buyers shop for goods and sellers offer products and services. It’s the hub of information about a company and what they sell.</p>
      </div>
    </div>
  );
};
